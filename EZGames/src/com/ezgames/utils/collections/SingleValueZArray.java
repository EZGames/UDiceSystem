...
final class SingleValueZArray<T> extends ZArray<T>
{
	
	// Public constructors *************************************
	public SingleValueZArray(T o) throws IllegalArgumentException
	{
		DataChecker.checkDataNotNull(o,
				"Cannot create a ZRollerArray from a null element");
		item = o;
	}
	...
	private class SingleValueArrayIterator implements Iterator<T>
	{
		...
		public void remove()
		{
			throw new UnsupportedOperationException(
					"ZRollerArray is Immutable and does not allow removing elements");
		}
