package com.ezgames.utils.hashing;
 ...
 * &emsp; 	HashUtil hasher = HashUtil.createDefaultHashUtil(); <br>
 * &emsp;	int code = hasher.getStartingValue();<br>
 * &emsp;	code = hasher.hash(member1, out);<br>
 * &emsp;	code = hasher.hash(member2, out);<br>
 * &emsp;	return code;<br>
 * }
 * 
 */
public class HashUtil
{
    ...
    * {@code IHashAlgorithm}.
    * <p>In most cases, the user of this method only needs to create the 
    * {@code IHashAlgorithm} object in the constructor.</p>
    * <p>i.e. {@code new HashUtil(new SpecificHashAlgorithm())}</p>
    * <p>As an alternative, you can use some of {@code HashUtil}'s 
    * built-in {@code IHashAlgorithm}s.</p>
    * <p>i.e. {@code new HashUtil(HashUtil.getFnvHashAlgorithm())}</p>
    * <p>See {@code HashUtil}'s static methods for all its built-in hashing
    * techniques.
    * @param strategy - the {@code IHashAlgorithm} to apply
    */
   public static HashUtil createHashUtilWith(IHashAlgorithm strategy)
   {
   ...
   //**************************************************************************
   /**
    * Returns the starting total for the hashing technique given in the constructor.
   ...
   //**************************************************************************
   private HashUtil(IHashAlgorithm strategy)
   {
