 ...
 * <p>
 * For example, you can make a new list of objects like this: {@code 
 * obj1.and(obj2).and(obj3).and(obj4)}</p>
 * <p>
 * See {@link ezgames.utils.collections} for a better idea of the entire collections
...
public interface Stackable<T extends Stackable<T>>
{
	/**
	 * <p>
	 * Creates an {@link MlList} from two objects
	 * of the same type, {@code T}.</p>
	 * <p>
	 * This, coupled with {@code MlList}'s {@link #and} method, allows users 
	 * to create collections of {@code Stackable} objects very simply.</p> 
	 * <p>
	 * ex. {@code obj1.and(obj2).and(obj3).and(obj4)}</p>
