...
public class MethodReferenceEventListenerTest
{
	public static void main(String[] args)
	{
		EventProducer producer = new EventProducer();
		EventListener listener = MethodReferenceEventListenerTest::referenceListener;
		
		producer.addListener(MethodReferenceEventListenerTest::referenceListener);
		...
		producer.removeListener(MethodReferenceEventListenerTest::referenceListener);
