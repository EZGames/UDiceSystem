...
public interface Tuple4<T1, T2, T3, T4>
{
	 ...
	 */
	Tuple4<T1, T2, T3, T4> useOne(Consumer<? super T1> func);
	/**
	 ...
	 * @return <code>this</code>, for method chaining.
	 */
	Tuple4<T1, T2, T3, T4> useTwo(Consumer<? super T2> func);
	/**
	 ...
	 * @return <code>this</code>, for method chaining.
	 */
	Tuple4<T1, T2, T3, T4> useThree(Consumer<? super T3> func);
	/**
	 * @return the third object in the tuple
	 */
	T4 four();
	 ...
	 * @return <code>this</code>, for method chaining.
	 */
	Tuple4<T1, T2, T3, T4> useFour(Consumer<? super T4> func);
	/**
	 * @return the same tuple in reverse order
	 */
	Tuple4<T4, T3, T2, T1> swap();
	...
	{
		return new Tuple4Impl<>(one, two, three, four);
	}
}
